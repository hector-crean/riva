...
pub struct Transaction<Presence> where Presence: PresenceLike, ClientMessage<Presence>: Serialize + for<'de> Deserialize<'de> {
    pub id: String,
...
impl<Presence> Transaction<Presence> where Presence: PresenceLike, ClientMessage<Presence>: Serialize + for<'de> Deserialize<'de> {
    #[must_use]
...
pub struct TransactionManager<Presence> where Presence: PresenceLike, ClientMessage<Presence>: Serialize + for<'de> Deserialize<'de> {
    history: VecDeque<Transaction<Presence>>,
    undone: VecDeque<Transaction<Presence>>,
    max_history: usize,
}

impl<Presence> TransactionManager<Presence> where Presence: PresenceLike, ClientMessage<Presence>: Serialize + for<'de> Deserialize<'de> {
    #[must_use]
